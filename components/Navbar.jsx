              ...
              {navigation.map((item) => (
                <a
                  ...
                  className={classNames(
                    item.current ? 'bg-gray-900 text-[#EEEEEE]' : 'text-[#EEEEEE]  hover:bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:text-white',
      ...
      <div className="space-y-1 px-2 pt-2 pb-3">
        {navigation.map((item) => (
          <Disclosure.Button
            ...
            href={item.href}
            className={classNames(
              item.current ? 'bg-gray-900 text-[#EEEEEE]' : 'text-[#EEEEEE] hover:bg-[#33B74B] hover:text-white',
